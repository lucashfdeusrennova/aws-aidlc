# Team Practices — Chatbot de RH com AgentCore

> Cinco seções afirmadas do stage `practices-discovery`. Após o gate, este
> arquivo é promovido para `aidlc/spaces/default/memory/team.md` pelo comando
> `aidlc-state.ts practices-promote`.
>
> Fontes consultadas: `aidlc/spaces/default/memory/org.md` (defaults do
> framework), `tech-env.md` (stack e restrições técnicas), `vision.md` (metas
> do demo de 2 dias), `constraint-register.md`, contribuições dos support
